...
LEADERBOARD_DATA = [
    ...
    LeaderboardUser(rank=2, name="David Kim", avatar="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100", xp=4120, streak=19, badge="RHCSA Specialist"),
...
ASSESSMENTS_DATA = [
    ...
    RecruiterAssessment(id="eval-02", title="RHCSA System Administrator Screening", topic="Users, Permissions, Storage", duration_minutes=60, candidate_count=8, status="Completed"),
]
